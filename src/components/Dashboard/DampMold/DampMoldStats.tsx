  ...
  return (
    <Card className="bg-gradient-to-br from-green-50 to-white border border-green-100">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg font-medium text-green-800">Key Metrics</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col">
            ...
            <div className="flex items-center">
              <CloudRain className="h-4 w-4 text-green-600 mr-1.5" />
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center">
              <Droplet className="h-4 w-4 text-green-600 mr-1.5" />
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center">
              <ThermometerSun className="h-4 w-4 text-green-600 mr-1.5" />

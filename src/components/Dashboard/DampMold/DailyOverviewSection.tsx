        ...
        <div className="mt-2 w-full">
          ...
          <div className="flex flex-col md:flex-row gap-6 w-full">
            <div className="w-full md:w-1/4">
              <p className="text-sm text-card-foreground/80 dark:text-gray-300">{chartDescription}</p>
              <div className="mt-4 info-panel bg-accent/10 p-3 rounded-md border border-accent/20 dark:bg-accent/5 dark:border-accent/10">
                <p className="text-xs font-medium dark:text-gray-200">Mould Risk Scoring</p>
                <ul className="text-xs mt-1 list-disc pl-4 space-y-1 dark:text-gray-300">

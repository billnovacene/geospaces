...
export function SummaryStats({
  ...
  return <>
      ...
      <div className="hidden md:flex space-x-4">
        {stats.map((stat, index) => <div key={index} className="flex flex-col space-y-1 mx-[15px] bg-white">
      ...
      <div className="grid grid-cols-5 gap-4 mb-8 md:hidden mx-auto w-3/4">
        {stats.map((stat, index) => <div key={index} className="flex flex-col space-y-1">
